...
CREATE TABLE `playlist` (
  ...
  `artistaid` int(11) NOT NULL,
  `nombre` varchar(50) NOT NULL,
  `descripcion` varchar(200) DEFAULT 'Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit',
  `fechacreacion` date NOT NULL,
  PRIMARY KEY (`playlistid`),
  KEY `fk_artista_playlist_idx` (`artistaid`),
  CONSTRAINT `fk_artista_playlist` FOREIGN KEY (`artistaid`) REFERENCES `artista` (`artistaid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `playlist` VALUES (1,27,'Best punk','Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipi','2017-06-20'),(2,25,'Loca Mamu','Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit','2017-06-20');
...
CREATE TABLE `playlist_cancion` (
  ...
  KEY `fk_cancion_idx` (`cancionid`),
  CONSTRAINT `fk_cancion` FOREIGN KEY (`cancionid`) REFERENCES `cancion` (`cancionid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_playlist` FOREIGN KEY (`playlistid`) REFERENCES `playlist` (`playlistid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `playlist_cancion` VALUES (1,27),(2,27),(2,39),(2,67),(2,74),(1,92);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_addcancionplaylist` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_addcancionplaylist`(
_playlistid int,_cancionid int)
BEGIN
insert into playlist_cancion(playlistid,cancionid)
values(_playlistid,_cancionid);
END ;;
DELIMITER ;
...
BEGIN
SELECT DISTINCT a.artistaid,a.nombre,a.apellido,a.fechanacimiento,a.nombreartistico,a.rutaimgperfil,a.email,a.passwd
 FROM Artista a join Album b on a.artistaid=b.artistaid join Cancion c on b.albumid=c.albumid
 join Genero g on c.generoid=g.generoid where g.generoid=_generoid;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_mejores4albumesdelartista` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_mejores4albumesdelartista`(
_artistaid int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_mejores4cancionesdelartista` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_mejores4cancionesdelartista`(
_artistaid int)
BEGIN
...
-- Dump completed on 2017-06-22 12:37:35
